...
import { GroupId, RequestUser } from 'src/common/types/utilTypes';
...
export class GroupMembersController {
  ...
  async deleteGroupMember(
    ...
    console.log(req.user._id, params.endUserId, params.groupId);
  ...
  async leaveGroup(@Req() req: RequestUser, @Param() params: LeaveGroupDto) {
    console.log('leaveGroup', params.groupId);
    const groupMember = await this.groupMembersService.leaveGroup(
      req.user._id,
      new mongoose.Types.ObjectId(params.groupId) as GroupId,
    );
    return groupMember;
  }
}
